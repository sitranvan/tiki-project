...
const promotionItems = document.querySelectorAll(".promotion-product__link")
...
function renderDetail(img, name, priceProduct, discount) {
    document.title = name
...
Array.from(promotionItems).forEach(item => {
    item.addEventListener('click', (e) => {
        main.classList.add("hidden")
        details.classList.add("show")

        // get info product card wrapper page
        const img = item.querySelector(".promotion-product__link img").src
        const name = item.querySelector(".promotion-product__link__name").textContent
        const priceProduct = item.querySelector(".promotion-product__link__price span:first-child").textContent
        const discount = item.querySelector(".promotion-product__link__price span:last-child").textContent

        renderDetail(img, name, priceProduct, discount)
